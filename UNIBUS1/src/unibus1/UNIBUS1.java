...
public class UNIBUS1 {
    ...
    public static void main(String[] args) {
        ...
        String nombre,apellido,nomusuario;
        ...
        System.out.println("escoge universidad: unipriv o unipublic");
        String eleccionuniversidad=input.nextLine();
        String[] unisPublicas={"(tec)","(tec2)","(uach)","(upn)","(up)","(utch)","(cam)", "(cima)","(cin)","(arqui)","(ets)","(nsuper)","(normal)"};
        String[] unisPrivadas={"(unea)","(cdes)","(urn)","(escograf)","(cuc)", "(tecmilenio)", "(unidep)"};
        
         if (eleccionuniversidad.equalsIgnoreCase("unipublic")) {
        System.out.println("Seleccionaste universidad publica");
        System.out.println("Instituto Tecnológico de Chihuahua(tec)\n"+ 
            ...
            "Instituto Benemérita y Centenaria Escuela Normal del Estado de Chihuahua, Prof. Luis Urías Belderráin(normal)\n");
             mostrarCamionesPorUniversidad(nomusuario,eleccionuniversidad,unisPublicas);
             preguntarRutas(input);
             
    } else if (eleccionuniversidad.equalsIgnoreCase("unipriv")) {
        System.out.println("Seleccionaste universidad privda");
            ...
            "UNIDEP(unidep)\n");
             mostrarCamionesPorUniversidad(nomusuario,eleccionuniversidad,unisPrivadas);
             preguntarRutas(input);
    } else {
